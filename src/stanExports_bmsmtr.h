...
namespace model_bmsmtr_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bmsmtr");
    reader.add_event(71, 69, "end", "model_bmsmtr");
    return reader;
}
#include <stan_meta_header.hpp>
class model_bmsmtr
  : public stan::model::model_base_crtp<model_bmsmtr> {
private:
        int S;
        std::vector<int> nY;
        int dX;
...
public:
    model_bmsmtr(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bmsmtr_namespace::model_bmsmtr";
        ...
        try {
            ...
            validate_non_negative_index("W", "dY", dY);
            num_params_r__ += dY;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("W", "dY", dY);
        context__.validate_dims("parameter initialization", "W", "vector_d", context__.to_vec(dY));
        Eigen::Matrix<double, Eigen::Dynamic, 1> W(dY);
        size_t W_j_1_max__ = dY;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                W = in__.vector_constrain(dY, lp__);
            else
                W = in__.vector_constrain(dY);
            current_statement_begin__ = 38;
            ...
            for (int s = 1; s <= S; ++s) {
                ...
                for (int d = 1; d <= dY; ++d) {
                    ...
                    lp_accum__.add(normal_log<propto__>(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_min_max(get_base1(get_base1(iY, s, "iY", 1), 1, "iY", 2), get_base1(get_base1(iY, s, "iY", 1), 2, "iY", 2)), stan::model::cons_list(stan::model::index_uni(d), stan::model::nil_index_list())), "Y"), multiply(multiply(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_min_max(get_base1(get_base1(iY, s, "iY", 1), 1, "iY", 2), get_base1(get_base1(iY, s, "iY", 1), 2, "iY", 2)), stan::model::nil_index_list()), "X"), transpose(get_base1(betaT, s, "betaT", 1))), (0.5 + (get_base1(W, d, "W", 1) / 2))), get_base1(sigma, s, "sigma", 1)));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bmsmtr_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> W = in__.vector_constrain(dY);
        size_t W_j_1_max__ = dY;
        for (size_t j_1__ = 0; j_1__ < W_j_1_max__; ++j_1__) {
...
typedef model_bmsmtr_namespace::model_bmsmtr stan_model;
#ifndef USING_R
